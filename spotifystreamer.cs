    ...
    public class Browser
    {
            ...
            Browser(int id, string email, string bind)
        {
            ...
            try
            {
                ...
                IEnumerator<int> port_ = Program.port_genrator;
                port_.MoveNext();
            ...
            catch (WebDriverException ex)
            {
                ...
                {
                    log.errorlogger(ex, true);log.Threadlogger(Thread_id, ex.ToString());
                }
            }
            catch (Exception ex)
            {
        ...
        public bool Email_input(string email, string password)
        {
            var wait4 = new WebDriverWait(driver, TimeSpan.FromSeconds(15));
            try
            {
        ...
        // Browser
        public bool Follow_artist(int number)
        {
            var wait4 = new WebDriverWait(driver, TimeSpan.FromSeconds(3));
            try
            {
        ...
        public bool like_playlist(int number)
        {
            var wait4 = new WebDriverWait(driver, TimeSpan.FromSeconds(3));
            try
            {
        ...
        public bool Post_check()
        {
            ...
            try
            {
                wait4.Until(c => c.FindElement(By.CssSelector("[aria-rowindex='2']")));
                return true;
        ...
        public bool Loader_checker()
        {
            var wait4 = new WebDriverWait(driver, TimeSpan.FromSeconds(5));
            try
            {
                wait4.Until(c => c.FindElement(By.ClassName("ytp-play-button")));
                return true;
