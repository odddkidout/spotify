                ...
                using (var client = new HttpClient())
                {
                    ...
                    if (response.IsSuccessStatusCode)
                    {
                        if (response.Content.ReadAsStringAsync().Result != "[]")
                        {
                            ...
                            configuration.song_url_list_file = Convert.ToString(temp[0].song_url_list_file);
                            ...
                            { 
                                ...
                                { 
                                    ...
                                    { 
                                        configuration.v_proxy = Convert.ToString(temp[0].v_proxyx); 
                                ...
                                { 
                                    configuration.proxy_info = Convert.ToString(temp[0].proxy_info); 
                            ...
                            { 
                                configuration.stream_proxy = Convert.ToString(temp[0].stream_proxy); 
